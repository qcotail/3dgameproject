...
public class NewSoundEffects : MonoBehaviour {

    [SerializeField] private NewSoundEffectBunch[] soundEffects;
    private Dictionary<string, List<AudioClip>> sounds;
    private void Awake() {
        sounds = new Dictionary<string, List<AudioClip>>();
        foreach (NewSoundEffectBunch bunch in soundEffects) {
...
[System.Serializable]
public struct NewSoundEffectBunch {
    public string name;
